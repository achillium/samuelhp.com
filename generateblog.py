...
<script>
    ...
    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
    ...
    this.page.url = "samuelhp.com/b/{output_file}";  // Replace PAGE_URL with your page's canonical URL variable
    this.page.identifier = "{output_file}"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
    }};
    */
